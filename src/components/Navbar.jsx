...
const Navbar = () => {
  ...
  useEffect(() => {
    const closeOnOutsideClick = (event) => {
      if (isOpen && drawerRef.current && !drawerRef.current.contains(event.target) && !menuButtonRef.current?.contains(event.target)) setIsOpen(false);
    };
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          >
            Dudekula Kullayappa <span className="text-[#ff2a2a]">.</span>
          </a>
        </div>
